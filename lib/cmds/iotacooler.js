...
smidgen iotacooler recover-funds-send <signed bundle as trytes>
...
function cli ([ command, ...args ], cb) {
  ...
  switch (command) {
    ...
    case 'recover-funds-send':
      [ tryteBundle ] = args
      recoverFundsSend(smidgen.iota, tryteBundle, cb)
      break
...
function recoverFundsSend (iota, tryteBundle, cb) {
